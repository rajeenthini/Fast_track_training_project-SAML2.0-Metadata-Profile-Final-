...
<%
    ...
    SAMLSSOIdentityProviderDTO retrievedObject = null;
    SAMLSSOIdentityProviderDTO provider = null;
    ...
    if (idpAction != null && "addIdentityProviderFromFile".equals(idpAction)) {
                    ...
                    String fileContent = IdPManagementUIUtil.getFileContent(request,"test");



                    retrievedObject = client.addMetadataServiceProviderSAMLObjectOnlyFromFile(fileContent);
                    System.out.println(retrievedObject);

                     provider = retrievedObject;


                     boolean fileAddedStatus = client.addMetadataServiceProviderFileContentOnly(fileContent,"idpEntityId");

    }

    if (idpAction != null && "addIdentityProviderFromUrl".equals(idpAction)) {
            ...
            <div class="toggle_container sectionSub" style="margin-bottom:10px;" id="saml2SSOLinkRow">
                <table class="carbonFormTable">
                    ...
                    <tr>
                        ...
                        <td>
                            <input id="idPEntityId" name="idPEntityId" type="text" value=<%=provider.getIdpEntityId()%>>
                            <div class="sectionHelp">
                    ...
                    <tr>
                        ...
                        <td>
                            <input id="spEntityId" name="spEntityId" type="text" value=<%=provider.getSpEntityId()%>>
                            <div class="sectionHelp">
                    ...
                    <tr>
                        ...
                        <td>
                            <input id="ssoUrl" name="ssoUrl" type="text" value=<%=provider.getUrlSSO()%>>
                            <div class="sectionHelp">
                    ...
                    <tr>
                                            <td class="leftCol-med labelField" ><fmt:message key='idp.saml.sso.metadata'/>:</td>
                                            <td>

                                                <input type="file" id="metaFile" name="metaFile" size="60" /><br />
                                            ...
                                            <td>
                                                 ...
                                                 <input type="submit" name="upload file 2" id="upload file 2" value="upload file" formaction='idp-mgt-metadata-add-finish.jsp?idpAction=addIdentityProviderFromFile&idPName=<%=idPName%>' formenctype="multipart/form-data" formmethod="post" />
                    ...
                    <tr>
                                            <td class="leftCol-med labelField" >Enter the Metadata URL:</td>
                                            <td>

                                                <input type="text" id="metadataURL" name="metadataURL" /><br />
                                            ...
                                            <td>
                                                 ...
                                                 <input type="submit" name="upload file url" id="upload file url" value="Get metadata from URL" formaction='idp-mgt-metadata-add-finish.jsp?idpAction=addIdentityProviderFromUrl'/>
