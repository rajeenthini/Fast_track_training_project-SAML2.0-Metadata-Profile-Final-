...
<script>
    ...
    function configureFromFile(){
        debugger;
        $("#idp-mgt-edit-form").unbind();
        $("#idp-mgt-edit-form").attr("action","idp-mgt-metadata-add-finish.jsp?idpAction=addIdentityProviderFromUrl");
        $('#idp-mgt-edit-form').submit(function(e){
	        e.preventDefault();
	        $.ajax({
	            type: "POST",
    ...
    <div id="middle">
        ...
        <form id="idp-mgt-edit-form" name="idp-mgt-edit-form" method="post" action="idp-mgt-edit-finish.jsp" enctype="multipart/form-data" >
            ...
            <h2 id="saml2_sso_head"  class="sectionSeperator trigger active" style="background-color: beige;">
                <a><fmt:message key="saml2.web.sso.config"/></a>
                ...
                <table class="carbonFormTable">
                    ...
                    <tr>
                     ...
                     <tr>
                                        ...
                                        <td>
                                             ...
                                             <!--input type="button" name="upload_file_url" value="Get metadata from URL" onclick="configureFromFile();"/-->
                                             <input type="submit" name="upload_file_url" id="upload_file_url" value="Get metadata from URL" formaction="idp-mgt-metadata-add-finish.jsp?idpAction=addIdentityProviderFromUrl"  formmethod="post"/>
                                        </td>
                    ...
                    <tr>
                                        ...
                                        <td>
                                             ...
                                             <input type="submit" name="upload_file" id="upload_file" value="upload file" formaction='idp-mgt-metadata-add-finish.jsp?idpAction=addIdentityProviderFromFile&idPName=<%=idPName%>' formenctype="multipart/form-data" formmethod="post" />
...
<form action="test.jsp?idpAction=addIdentityProviderFromUrlTest" method="post">
    <table>
        <tr>
            <td>Enter MetadataUrl</td>
            <td><input type="text" name="url" id="url"></td>
        </tr>
        <tr>

                    <td><input type="submit" name="geturl" id="geturl" ></td>
        </tr>
    </table>
</form>
</fmt:bundle>