...
public class IdPManagementUIUtil {
    ...
    public static String chkStringReturn(String request) {
        String retrievedText = request;
        return retrievedText;
    }

    public static String getFileContent(HttpServletRequest request, String test) {
    ...
    public static String getFileContentFromURL(HttpServletRequest request, String metadataURL) throws Exception {

        URL website = new URL(metadataURL);
    ...
    public static String getIdPEntityId(IdentityProvider identityProvider) {
        ...
        if (configs != null) {
            for (FederatedAuthenticatorConfig config : configs) {
                if ("SAMLSSOAuthenticator".equals(config.getName())) {
