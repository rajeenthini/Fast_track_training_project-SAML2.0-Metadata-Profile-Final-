...
public class IdentityProviderManagementService extends AbstractAdmin {
     ...
     */
    public SAMLSSOIdentityProviderDTO addMetadataServiceProviderFromFile(String fileContent) throws IdentityException {


        SAMLSSOMetadataConfigManager metadataConfigManager = new SAMLSSOMetadataConfigManager(getConfigUserRegistry());

        return metadataConfigManager.readIdentityProvidersFromFile(fileContent);
    }
     ...
     * @throws org.wso2.carbon.identity.base.IdentityException
     */
    public SAMLSSOIdentityProviderDTO addMetadataServiceProviderFromUrl(String fileContent) throws IdentityException {


        SAMLSSOMetadataConfigManager metadataConfigManager = new SAMLSSOMetadataConfigManager(getConfigUserRegistry());

        return metadataConfigManager.readIdentityProvidersFromUrl(fileContent);
    }
     ...
     */
    public boolean isMetadataFileAdded(String fileContent, String idpEntityId) throws IdentityException {
        boolean fileAddedStatus = false;


        SAMLSSOMetadataConfigManager metadataConfigManager = new SAMLSSOMetadataConfigManager(getConfigUserRegistry());
        fileAddedStatus = metadataConfigManager.addMetadataSAMLSSOFileResource(fileContent, idpEntityId);
