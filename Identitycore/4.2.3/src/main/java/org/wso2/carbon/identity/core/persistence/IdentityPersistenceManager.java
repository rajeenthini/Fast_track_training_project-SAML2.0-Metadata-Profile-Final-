...
public class IdentityPersistenceManager {
    ...
    /**
     * Add a relying party service provider for SAML SSO by metadata file to registry
     *
     ...
     * @throws IdentityException
     */
    public boolean addMetadataServiceProvider(Registry registry, String fileContent, String issuer)
            throws IdentityException {


        SAMLSSOMetadataServiceProviderDAO samlssoMetadataServiceProviderDAO = new SAMLSSOMetadataServiceProviderDAO(registry);

        return samlssoMetadataServiceProviderDAO.addMetadataServiceProvider(fileContent, issuer);
    }

    /**
     * Add a identity provider for SAML SSO by metadata file to registry
     *
     * @param fileContent Content of a file
     * @param issuer      name of the issuer
     * @return boolean
     * @throws IdentityException
     */
    public boolean addMetadataIdentityProvider(Registry registry, String fileContent, String issuer)
            throws IdentityException {

        SAMLSSOMetadataIdentityProviderDAO samlssoMetadataIdentityProviderDAO = new SAMLSSOMetadataIdentityProviderDAO(registry);

        return samlssoMetadataIdentityProviderDAO.addMetadataIdentityProvider(fileContent, issuer);
