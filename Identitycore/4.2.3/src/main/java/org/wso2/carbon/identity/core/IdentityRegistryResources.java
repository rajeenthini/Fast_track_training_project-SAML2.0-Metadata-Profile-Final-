...
public class IdentityRegistryResources {
    ...
    public final static String SAML_SSO_METADATA_SERVICE_PROVIDERS = SAML_SSO_SERVICE_PROVIDERS + "SAMLSSOMetaData/";
    public final static String SAML_SSO_METADATA_SERVICE_PROVIDERS_INBOUND = SAML_SSO_METADATA_SERVICE_PROVIDERS + "ServiceProviderIn-Bound/";
    public final static String SAML_SSO_METADATA_IDENTITY_PROVIDERS_INBOUND = SAML_SSO_METADATA_SERVICE_PROVIDERS + "IdentityProviderIn-Bound/";
    ...
    public static final String PROP_SAML_SSO_METADATA_CONTENT = "metaDataContent";
    public static final String PROP_SAML_SSO_METADATA_ISSUERNAME = "metadataFileName";
