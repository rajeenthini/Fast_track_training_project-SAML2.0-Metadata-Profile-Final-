...
public class SAMLSSOConfigService extends AbstractAdmin {
     ...
     * @throws IdentityException
     */
    public SAMLSSOServiceProviderDTO addMetadataServiceProviderFile(String fileContent) {
    ...
    /**
     * add SAML SSO object by uploading file from url
     *
     * @param metadataUrl url of a metadata file
     * @return SAMLSSOServiceProviderDO
     * @throws IdentityException
     */
    public SAMLSSOServiceProviderDTO addMetadataServiceProviderUrl(String metadataUrl) {
     ...
     * @throws IdentityException
     */
    public Boolean isMetadataFileAdded(String fileContent, String issuer) throws IdentityException {
        boolean fileAddedStatus;
